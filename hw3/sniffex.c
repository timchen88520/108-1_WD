...
char count_ip_srt_name[1000][30];
int count_ip_srt_name_num[1000];
int count_ip_srt_num=0;
...
void got_packet(u_char *args, const struct pcap_pkthdr *header, const u_char *packet)
{
	...
	if(flag1==0){
		strcpy(count_ip_srt_name[count_ip_srt_num],src);
		count_ip_srt_num++;
		count_ip_srt_name_num[count_ip_srt_num]++;
	}
...
int main(int argc, char **argv)
{
	...
	const char *filter= " ";		/* filter expression [3] */
